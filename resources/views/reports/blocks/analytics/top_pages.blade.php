...
@endphp
@include('reports.blocks.partials.heading', ['text' => $heading ?: 'Top pages', 'icon' => $icon ?? 'chart', 'suffix' => $data['provider'] ?? null])

@if (empty($pages))
    <p class="muted">No page data for this period.</p>
@else
    <div class="table-scroll">
        <table class="data">
            <thead><tr><th>Page</th><th style="width:34%;">Views</th><th>Visitors</th></tr></thead>
            <tbody>
