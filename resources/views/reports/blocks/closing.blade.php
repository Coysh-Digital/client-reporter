@include('reports.blocks.partials.heading', ['text' => $heading ?: \App\Support\ReportLang::get('closing.heading'), 'icon' => $icon ?? 'document', 'variant' => 'title'])
...
@if (($data['email'] ?? null) || ($data['phone'] ?? null) || ($data['website'] ?? null))
    <p class="muted" style="margin-top: 16px;">
        {{ \App\Support\ReportLang::get('closing.get_in_touch') }}
