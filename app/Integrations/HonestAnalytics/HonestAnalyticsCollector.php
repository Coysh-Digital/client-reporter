...
/**
 * Pulls Honest Analytics into the normalised analytics.* metric layer, plus a
 * snapshot with top pages, sources, devices and a daily timeseries — the same
 * shape the other analytics providers emit, so it feeds every Analytics report
 * block and the site-page charts without any provider-specific rendering.
 */
class HonestAnalyticsCollector extends AbstractCollector
{
